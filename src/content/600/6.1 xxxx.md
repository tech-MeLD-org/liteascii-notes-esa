...
![700x499](attachments/6.1%20xxxx/file-20260306142132245.png)
...
![700x518](attachments/6.1%20xxxx/file-20260306142132249.png)
...
![](attachments/6.1%20xxxx/file-20260306142132255.png)
...
- 下载 `Git` 可以查看这里：[2.4.1 xxx](../200/2.4%20xxx/2.4.1%20xxx.md#1.%20Windows%20下载安装%20git%20客户端)
- 下载 `NodeJS` 可以查看这里：[2.5.1 xxx](../200/2.5%20xxx/2.5.1%20xxx.md#安装%20NodeJS)
...
![](attachments/6.1%20xxxx/file-20260306142132261.png)
...
![](attachments/6.1%20xxxx/file-20260306142132266.png)
...
![](attachments/6.1%20xxxx/file-20260306142132269.png)
...
![700x618](attachments/6.1%20xxxx/file-20260306142132292.png)
...
![](attachments/6.1%20xxxx/file-20260306142132298.png)

这里的构建命令需要修改为 `npx quartz build`，使用 Quartz 的构建命令，然后点击开始部署
注意这里的 `项目名称` 我们后期配置 `esa-cli` 的指令时还会用到，请记住这个名称

![](attachments/6.1%20xxxx/file-20260306142132303.png)

构建失败先不用管，因为我们还没有配置 `esa-cli`

![](attachments/6.1%20xxxx/file-20260306142132307.png)
...
- 注意：这里的 `name` 填写之前你创建过的 ESA 应用的项目名称。[6.1 xxxx](6.1%20xxxx.md#开通%20ESA%20并创建应用)

将 `QuartzSite` 文件夹全部项目推送到 GitHub 后，我们可以在 GitHub 的查看 Actions 中的运行情况

![](attachments/6.1%20xxxx/file-20260306142132344.png)

进入 `workflow` 查看运行情况

![](attachments/6.1%20xxxx/file-20260306142132348.png)

同时，我们可以在阿里云的边缘加速 ESA 看到自己之前创建失败的应用，进入应用查看他的部署情况，等待部署成功，使用他提供的临时域名访问网站

注意：如果已经购买过域名，也可以自行配置到该应用中

![](attachments/6.1%20xxxx/file-20260306142132353.png)
...
![700x156](attachments/6.1%20xxxx/file-20260306142132358.png)

![](attachments/6.1%20xxxx/file-20260306142132363.png)